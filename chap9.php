...
<html>
  ...
  <body>
    ...
    <a href=""  style="text-decoration: none; background-color: #64abfb; padding: 20px; color: white; font-size: 1.2em; margin-right: 25px;">Les fonctions affectant les array</a>
  </div>
      </div>
